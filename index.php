...
<body  class= " jumbotron-fluid">
  ...
  <style>
   ...
   <style>
    <?php include './estilos/hexagonos.css';
    ?>
  </style>
  <style>
    <?php include './2menu/css/style.css';
    ?>
  </style>
      ...
      <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar">
          ...
          <ul class="list-unstyled components mb-5">
            <li class="active">
              <a href="http://localhost/inmobiliario/index.php"><i class="bi bi-house"></i> Inicio</a>
            </li>
            <li class="active">
              <a href="#"><span class="bi bi-house"></span> Hola1</a>
            </li>
            <li class="active">
              <a href="#"><i class="bi bi-file-earmark"></i>Hola1</a>
            </li>
            <li class="active">
              <a href="#"><i class="bi bi-file-earmark"></i>Hola1</a>
            </li>
...
<div class="container-fluid p-0 ml-5">
 ...
 <br><br><br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                                ...
                                <div href="#" class="hexagon-menu clear">
                                    <div class="hexagon-item">
                                        ...
                                        <a href="#" class="hex-content">
                                            <span class="hex-content-inner">
                                                ...
                                                <span class="title">Ver Inmuebles</span>
                                            </span>
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="#" class="hex-content">
                                            <span class="hex-content-inner">
                                                ...
                                                <span class="title">Vender Inmueble</span>
                                            </span>
                                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" ><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                        </a>
                                    </div>
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a href="#" class="hex-content">
                                            <span class="hex-content-inner">
                                                ...
                                                <span class="title">Simulador Finanzas</span>
                                            </span>
                                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" ><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                        </a>
                                    </div>
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./img/skyskapess.jpg" class="d-block w-100 h-100" alt="..." width="0" height="924">
      <div class="carousel-caption d-none d-md-block">
        <span>First slide label</h5>
        <p>Some representative placeholder content for the first slide.</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="./img/skyskapes.jpg" class="d-block w-100 h-100" alt="..." width="0" height="924">
      <div class="carousel-caption d-none d-md-block">
